...
class Ntp {
  ...
  private:
          ...
          int         currenttime         = 0;
          const char* time_zone           = "COT5"; //"EST+5EDT,M3.2.0/2,M11.1.0/2"; //timezone for us east WITH daylight savings //"CET-1CEST,M3.5.0,M10.5.0/3";  // TimeZone rule for Europe/Rome including daylight adjustment rules (optional)
